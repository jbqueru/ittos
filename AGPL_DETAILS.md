...
code for the ITTOS demo, and these are my personal notes about
...
On the other hand, as of 2024, I now try to prefer the GPL family
for my own Open Source projects, because I believe that recipients
and users of software should be given the legal rights, technical
means, and necessary information, that they need in order to maintain
...
At the time of writing, i.e. 2024, the current versions of the GPL
are LGPLv3, GPLv3 and AGPLv3, which were orriginally published in 2007.
...
While I realize that this is quite a stretch from the letter of AGPLv3,
it's also consistent with the spirit of GPL in general where users of
software must be allowed to maintain it and modify it, and with the
spirit of AGPL where that requirement applies even if no explicit
...
tangible products that include the program can replace the program with
